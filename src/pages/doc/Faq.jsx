                    ...
                    <div className="main-box-howtowear">
                        <div className="w-full">
                            ...
                            <div className="border-b border-gray-500 py-4">
                                ...
                                <p>
                                ・クリエイター（VIRTUAL FASHIONを作成する人）として登録したい方は<Link to="/login" className="text-blue-800 font-bold ml-1">こちらから </Link>
                                </p>
                                <p>
                            ...
                            <div className="border-b border-gray-500 py-4">
                                ...
                                <p>
                                ・クリエイター/クライアントともに<Link to="/how-to-wear" className="text-blue-800 font-bold ml-1">こちらをご確認ください </Link>
                                </p>
                            </div>
                            <div className="border-b border-gray-500 py-4">
